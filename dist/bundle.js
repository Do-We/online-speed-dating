...
/***/ function(module, exports, __webpack_require__) {
	...
	var _profileLinkController = __webpack_require__(167);

	var _profileLinkController2 = _interopRequireDefault(_profileLinkController);

	var _aboutUsController = __webpack_require__(170);

	var _aboutUsController2 = _interopRequireDefault(_aboutUsController);

	var _techStackController = __webpack_require__(173);

	var _techStackController2 = _interopRequireDefault(_techStackController);
	...
	_vue2.default.component('profilelink', _profileLinkController2.default);
	_vue2.default.component('aboutus', _aboutUsController2.default);
	_vue2.default.component('techstack', _techStackController2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function defineReactive$$1 (
	  ...
	  Object.defineProperty(obj, key, {
	    ...
	    set: function reactiveSetter (newVal) {
	      ...
	      if (("nim") !== 'production' && customSetter) {
	        customSetter();
	      }
	      if (setter) {
	...
	function resolveAsset (
	  ...
	  if (("nim") !== 'production' && warnMissing && !res) {
	    warn(
	...
	function flushSchedulerQueue () {
	  ...
	  for (index = 0; index < queue.length; index++) {
	    ...
	    if (("nim") !== 'production' && has$1[id] != null) {
	...
	function initMethods (vm) {
	  ...
	  if (methods) {
	    for (var key in methods) {
	      ...
	      if (("nim") !== 'production' && methods[key] == null) {
	        warn(
	...
	function renderMixin (Vue) {
	  ...
	  Vue.prototype._render = function () {
	    ...
	    if (!(vnode instanceof VNode)) {
	      if (("nim") !== 'production' && Array.isArray(vnode)) {
	        warn(
	...
	function createPatchFunction (backend) {
	  ...
	  function createElm (vnode, insertedVnodeQueue, parentElm, refElm, nested) {
	    ...
	    if (isDef(tag)) {
	      ...
	      if (("nim") !== 'production' && data && data.pre) {
	        inPre--;
	      }
	...
	var Transition = {
	  ...
	  render: function render (h) {
	    ...
	    if (("nim") !== 'production' && children.length > 1) {
	      warn(
	...
	function parse (
	  ...
	  parseHTML(template, {
	    ...
	    chars: function chars (text) {
	      if (!currentParent) {
	        if (("nim") !== 'production' && !warned && text === template) {
	          warned = true;
	          warn$1(
	...
	function processKey (el) {
	  ...
	  if (exp) {
	    if (("nim") !== 'production' && el.tag === 'template') {
	...
	function makeAttrsMap (attrs) {
	  ...
	  for (var i = 0, l = attrs.length; i < l; i++) {
	    if (("nim") !== 'production' && map[attrs[i].name] && !isIE) {
	...
	function resolveQuery (
	  ...
	  if (query) {
	    ...
	    try {
	      ...
	      ("nim") !== 'production' && warn(false, e.message)
	      parsedQuery = {}
	    }
	...
	var VueRouter = function VueRouter (options) {
	  ...
	  switch (mode) {
	    ...
	    case 'abstract':
	      ...
	      break
	    default:
	      ("nim") !== 'production' && assert(false, ("invalid mode: " + mode))
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _landingPageController = __webpack_require__(5);

	var _landingPageController2 = _interopRequireDefault(_landingPageController);
	...
	var _eventsController = __webpack_require__(154);

	var _eventsController2 = _interopRequireDefault(_eventsController);

	var _activeDateController = __webpack_require__(159);

	var _activeDateController2 = _interopRequireDefault(_activeDateController);

	var _myProfileController = __webpack_require__(162);

	var _myProfileController2 = _interopRequireDefault(_myProfileController);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var routes = [{
	  path: '/',
	  component: _landingPageController2.default
	}, {
	  path: '/video',
	  meta: { requiresAuth: true },
	  component: _activeDateController2.default
	}, {
	  path: '/signup',
	  ...
	  component: _adminController2.default
	}, {
	  path: '/myprofile/:id',
	  meta: { requiresAuth: true },
	  ...
	  children: [{
	    ...
	    path: '',
	    component: _myProfileController2.default
	  }]
	}, {
	  path: '/profile/:id',
	  meta: { requiresAuth: true },
	  ...
	  {
	    path: '',
	    component: _eventsController2.default
	  }]
	}, {
	  path: '/date/:dateid',
	  meta: { requiresAuth: true },
	...
	router.beforeEach(function (to, from, next) {
	  if (to.matched.some(function (record) {
	    ...
	    _vue2.default.http.post('auth/authorize').then(function (res) {
	      console.log(res.body);
	      _store2.default.commit('setUser', res.body);
	      _store2.default.commit('setSavedEvents', res.body.events);
	      next();
	    }).catch(function (res) {
	  ...
	  if (to.matched.some(function (record) {
	    ...
	    if (_store2.default.state.user) {
	      // console.log('logged in');
	      if (_store2.default.state.user.admin) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _landingPageTemplate = __webpack_require__(6);

	var _landingPageTemplate2 = _interopRequireDefault(_landingPageTemplate);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var app = {
	  template: _landingPageTemplate2.default.template,
	  data: function data() {
	    return {
	  ...
	  methods: {
	    TESTpublish: function TESTpublish() {
	      var _this = this;
	      ...
	      this.$http.post('/event/start', {
	        ...
	        var body = res.body;
	        _this.$store.commit('setUser', body);
	      }).catch(function (err) {
	        return console.error(err);
	      });
	    },

	    TESTpublash: function TESTpublash() {
	      var _this2 = this;
	      ...
	      this.$http.post('/event/setup', {
	        ...
	        var body = res.body;
	        _this2.$store.commit('setUser', body);
	      }).catch(function (err) {
	        return console.error(err);
	      });
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Users/nim/MKS/online-speed-dating/App/Client/Templates/landingPageTemplate.vue"
	  if (!module.hot.data) {
	  ...
	  methods: {
	    login: function login() {
	      ...
	      this.$http.post('/auth/login', {
	        ...
	        var body = res.body;
	        _this.$http.get('/api/events').then(function (res) {
	          _this.$store.commit('setAllEvents', res.body);
	        });
	        _this.$store.commit('setUser', body);
	        _this.$store.commit('setSavedEvents', body.events);
	      }).catch(function (err) {
	        return console.error(err);
	      });
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/nim/MKS/online-speed-dating/App/Client/Templates/loginTemplate.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _adminTemplate = __webpack_require__(12);

	var _adminTemplate2 = _interopRequireDefault(_adminTemplate);

	var _moment2 = __webpack_require__(18);
	...
	var admin = {
	  template: _adminTemplate2.default.template,
	  data: function data() {
	    return {
	      username: '',
	      date: '',
	  ...
	  methods: {
	    ...
	    setupEvent: function setupEvent(event) {
	      var _this = this;
	    ...
	    incrementRound: function incrementRound(event) {
	      this.$store.state.pubnub.publish({
	    ...
	    moment: function moment(date) {
	      return (0, _moment3.default)(date);
	    },
	    submit: function submit() {
	      ...
	      console.log(body);
	      var dbUrl = '/api/events';
	      this.$http.post(dbUrl, body).then(function (res) {
	        console.log(res.body);
	        _this2.$store.commit('setNewEvent', res.body);
	        //clear form fields
	        _this2.username = '', _this2.date = '', _this2.eventType = '', _this2.eventName = '';
	      }).catch(function (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/nim/MKS/online-speed-dating/App/Client/Templates/adminTemplate.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-47d60b50&file=adminTemplate.vue!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./adminTemplate.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-47d60b50&file=adminTemplate.vue!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./adminTemplate.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _videoTemplate = __webpack_require__(130);
	...
	var video = {
	  ...
	  computed: (0, _vuex.mapState)(['videoOut', 'sessionOut', 'username', 'name', 'phone', 'sessionIn']),

	  methods: {
	    makePhone: function makePhone(myNumber) {
	      this.phone = window.phone = PHONE({
	        number: myNumber, // listen on username line else Anonymous
	        publish_key: ("pub-c-41abaa19-40b9-451a-901b-bead25bf6337"),
	        subscribe_key: ("sub-c-ec0ccb80-c22e-11e6-b737-0619f8945a4f"),
	        ssl: true
	      });
	    ...
	    initStatePhone: function initStatePhone() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/nim/MKS/online-speed-dating/App/Client/Templates/videoTemplate.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _signupTemplate = __webpack_require__(134);
	  ...
	  methods: {
	    ...
	    login: function login() {
	      ...
	      this.$http.post('/auth/login', {
	        ...
	        var body = res.body;
	        _this2.$http.get('/api/events').then(function (res) {
	          _this2.$store.commit('setAllEvents', res.body);
	        });
	        _this2.$store.commit('setUser', body);
	        _this2.$store.commit('setSavedEvents', body.events);
	        _this2.$router.push('/');
	      }).catch(function (err) {
	        return console.error(err);
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/nim/MKS/online-speed-dating/App/Client/Templates/signupTemplate.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _profileTemplate = __webpack_require__(137);
	...
	var profile = {
	  ...
	  methods: {
	    ...
	    setProfileInfo: function setProfileInfo(res) {
	      for (var key in res) {
	        this[key] = res[key];
	      }
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/nim/MKS/online-speed-dating/App/Client/Templates/profileTemplate.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-7d11fa2c&file=profileTemplate.vue!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./profileTemplate.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-7d11fa2c&file=profileTemplate.vue!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./profileTemplate.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _profileCreationTemplate = __webpack_require__(142);
	  ...
	  methods: {
	    ...
	    setUserInfo: function setUserInfo() {
	      ...
	      if (!!body.name && !!body.gender && !!body.location) {
	        this.$http.put('/api/user', body).then(function (response) {
	          _this.$store.commit('setUser', body);
	          _this.$router.push('/myprofile/' + body.username);
	        }).catch(function (err) {});
	      } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/nim/MKS/online-speed-dating/App/Client/Templates/profileCreationTemplate.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-179f1769&file=profileCreationTemplate.vue!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./profileCreationTemplate.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-179f1769&file=profileCreationTemplate.vue!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./profileCreationTemplate.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/nim/MKS/online-speed-dating/App/Client/Templates/blank.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pubnub = __webpack_require__(149);

	var _pubnub2 = _interopRequireDefault(_pubnub);

	var _pubnubWebrtc = __webpack_require__(150);

	var _pubnubWebrtc2 = _interopRequireDefault(_pubnubWebrtc);
	...
	var store = new _vuex2.default.Store({
	  ...
	  getters: {
	    getProfileInfo: function getProfileInfo(state, name) {
	      return state.user;
	    }
	  },
	  mutations: {
	    ...
	    setSavedEvents: function setSavedEvents(state, arr) {
	      var tempSavedEvents = [];
	      for (var i = 0; i < arr.length; i++) {
	        _vue2.default.http.get('/api/user/events', { params: { _id: arr[i] } }).then(function (res) {
	          if (res.body._id) {
	    ...
	    initPubNub: function initPubNub(state) {
	      state.pubnub = new _pubnub2.default({
	        publishKey: ("pub-c-41abaa19-40b9-451a-901b-bead25bf6337"),
	        subscribeKey: ("sub-c-ec0ccb80-c22e-11e6-b737-0619f8945a4f"),
	        ssl: true
	      });
	      state.pubnub.addListener({
	        message: function message(_message) {
	          if (_message.message === 'Ready') {
	            console.log('GotReadyMessageFromPartner');
	            state.calleeReadyFlag = true;
	          } else if (_message.message === 'End') {
	            ...
	            console.log('This is round', _message.message);
	            state.phone.hangup();
	            ...
	            state.currentRound = _message.message;
	    ...
	    initPhone: function initPhone(state) {
	      state.phone = window.phone = new _pubnubWebrtc2.default({
	    ...
	    signalEventReadyFlags: function signalEventReadyFlags(state) {
	      state.beforeStartFlag = true;
	      state.beforeEventFlag = false;
	      state.soloViewFlag = true;
	      state.activeEventFlag = true;
	    },
	    signalCalleeReadyFlag: function signalCalleeReadyFlag(state) {
	      state.calleeReadyFlag = true;
	    },
	    setEvents: function setEvents(state, arr) {
	      state.user.events = arr;
	    },
	    setAllEvents: function setAllEvents(state, arr) {
	      state.allEvents = arr;
	    },
	    setNewEvent: function setNewEvent(state, event) {
	      state.allEvents.push(event);
	    },
	    addToSavedEvents: function addToSavedEvents(state, arr) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (config) {
	  ...
	  // -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
	  var rtcconfig = { iceServers: [{ 'url': navigator.mozGetUserMedia ? 'stun:stun.services.mozilla.com' : navigator.webkitGetUserMedia ? 'stun:stun.l.google.com:19302' : 'stun:23.21.150.121'
	  ...
	  var unablecb = function unablecb() {};
	  var debugcb = function debugcb() {};
	  var connectcb = function connectcb() {};
	  var disconnectcb = function disconnectcb() {};
	  var reconnectcb = function reconnectcb() {};
	  var callstatuscb = function callstatuscb() {};
	  var receivercb = function receivercb() {};
	  ...
	  function get_conversation(number) {
	    var talk = conversations[number] || function (number) {
	      ...
	      talk.thumbnail = function (cb) {
	        talk.thumb = cb;return talk;
	      };
	      talk.ended = function (cb) {
	        talk.end = cb;return talk;
	      };
	      talk.connected = function (cb) {
	        talk.connect = cb;return talk;
	      };
	      talk.message = function (cb) {
	        talk.usermsg = cb;return talk;
	      };
	  ...
	  PHONE.history = function (settings) {
	    pubnub.history({
	      ...
	      callback: function callback(call_history) {
	  ...
	  PHONE.snap = function (message, number) {
	    if (number) {
	      return get_conversation(number).snap(message);
	    }
	    var pic = {};
	  ...
	  PHONE.send = function (message, number) {
	    if (number) {
	      return get_conversation(number).send(message);
	    }
	    PUBNUB.each(conversations, function (number, talk) {
	      talk.send(message);
	    });
	  ...
	  PHONE.hangup = function (number) {
	    if (number) {
	      return get_conversation(number).hangup();
	    }
	    PUBNUB.each(conversations, function (number, talk) {
	      talk.hangup();
	    });
	  ...
	  PUBNUB.bind('unload,beforeunload', window, function () {
	    ...
	    PUBNUB.each(conversations, function (number, talk) {
	      ...
	      var url = 'https://pubsub.pubnub.com/publish/' + pubkey + '/' + subkey + '/0/' + number + '/0/' + (0, _stringify2.default)(message);
	  ...
	  function receive(message) {
	    ...
	    if (message.packet.thumbnail) {
	      return create_thumbnail(message);
	    }
	    ...
	    if (message.packet.sdp) {
	      add_sdp_offer(message);
	    } else {
	      add_ice_route(message);
	    }
	  }
	  ...
	  function add_sdp_offer(message) {
	    ...
	    pc.setRemoteDescription(new SessionDescription(message.packet), function () {
	  ...
	  function add_ice_route(message) {
	    ...
	    // Add ICE Candidate Routes
	    pc.addIceCandidate(new IceCandidate(message.packet), debugcb, debugcb);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core = __webpack_require__(153);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _eventsTemplate = __webpack_require__(155);

	var _eventsTemplate2 = _interopRequireDefault(_eventsTemplate);
	...
	var events = {
	  template: _eventsTemplate2.default.template,
	  data: function data() {
	    return {
	      username: this.username,
	      date: this.date,
	  ...
	  methods: {
	    getEvents: function getEvents() {
	      ...
	      this.$http.get('/api/events').then(function (res) {
	        ...
	        console.error('There was an err with your GET request, ', err);
	      });
	    },
	    hasNotJoined: function hasNotJoined(event) {
	    ...
	    join: function join(event) {
	      ...
	      if (currentUserEvents.indexOf(event._id) === -1) {
	        ...
	        this.$http.put('/api/user', this.$store.state.user).then(function (res) {
	          savedUserEvents.push(event);
	          //update savedEvents with new event added to user
	          _this2.$store.commit('addToSavedEvents', savedUserEvents);
	        }).catch(function (err) {
	          console.error('error ', err);
	        });

	        //update event on db with new usernames array
	        this.$http.put('/api/events', event).then(function (res) {
	          _this2.getEvents();
	        }).catch(function (err) {
	          console.error('error ', err);
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/nim/MKS/online-speed-dating/App/Client/Templates/eventsTemplate.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-4348935c&file=eventsTemplate.vue!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./eventsTemplate.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-4348935c&file=eventsTemplate.vue!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./eventsTemplate.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _activeDateTemplate = __webpack_require__(160);

	var _activeDateTemplate2 = _interopRequireDefault(_activeDateTemplate);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var activeDate = {
	  template: _activeDateTemplate2.default.template,
	  ...
	  methods: {
	    signalEventReady: function signalEventReady() {
	    ...
	    signalCalleeReady: function signalCalleeReady() {
	      this.$store.state.pubnub.publish({
	    ...
	    callCallee: function callCallee() {
	      this.$store.state.phone.dial(this.$store.state.user.callList[this.$store.state.currentRound]);
	    },

	    TESTcurrentRoundButton: function TESTcurrentRoundButton(number) {
	      this.$store.state.pubnub.publish({
	        message: number,
	    ...
	    TESTendEventButton: function TESTendEventButton() {
	      this.$store.state.pubnub.publish({
	        message: 'End',
	        channel: [this.event._id.$oid]
	      });
	    },
	    TESTSoloView: function TESTSoloView() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/nim/MKS/online-speed-dating/App/Client/Templates/activeDateTemplate.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _myProfileTemplate = __webpack_require__(163);

	var _myProfileTemplate2 = _interopRequireDefault(_myProfileTemplate);
	...
	var myProfile = {
	  name: 'myProfile',
	  template: _myProfileTemplate2.default.template,
	  data: function data() {
	    return {
	      savedEvents: '',
	      match: true
	  ...
	  computed: {
	    savedEvents: function savedEvents() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/nim/MKS/online-speed-dating/App/Client/Templates/myProfileTemplate.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-617c8444&file=myProfileTemplate.vue!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./myProfileTemplate.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-617c8444&file=myProfileTemplate.vue!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./myProfileTemplate.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _profileLinkTemplate = __webpack_require__(168);

	var _profileLinkTemplate2 = _interopRequireDefault(_profileLinkTemplate);
	...
	var profileLink = {
	  name: 'profileLink',
	  template: _profileLinkTemplate2.default.template,
	  data: function data() {
	    return {};
	  },
	  ...
	  methods: {
	    ...
	    logout: function logout() {
	      ...
	      this.$http.get('/auth/logout').then(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/nim/MKS/online-speed-dating/App/Client/Templates/profileLinkTemplate.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _aboutUsTemplate = __webpack_require__(171);

	var _aboutUsTemplate2 = _interopRequireDefault(_aboutUsTemplate);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var aboutus = {
	  template: _aboutUsTemplate2.default.template,
	  data: function data() {
	    return {
	      dan: '#',
	      elliott: '#',
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/nim/MKS/online-speed-dating/App/Client/Templates/aboutUsTemplate.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	module.exports = "\n <section id=\"about\" class=\"container content-section text-center\">\n        <div class=\"row\">\n            <h2>About Us</h2>\n            <div class=\"container\">\n                <div class=\"row aboutUs\">\n                    <div class=\"icons col-md-3\"> <img class=\"img_icons\" :src='dan' alt=\"\">\n                        <br/> Dan Gidlay </div>\n                    <div class=\"icons col-md-3\"> <img class=\"img_icons\" :src='elliott' alt=\"\">\n                        <br/> Elliott Birch </div>\n                    <div class=\"icons col-md-3\"> <img class=\"img_icons\" :src='eric' alt=\"\">\n                        <br/> Eric 'Chris' Lau </div>\n                    <div class=\"icons col-md-3\"> <img class=\"img_icons\" :src='wasiff' alt=\"\">\n                        <br/> Wasiff Afzal </div>\n                </div>\n            </div>\n        </div>\n    </section>\n\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _techStackTemplate = __webpack_require__(174);

	var _techStackTemplate2 = _interopRequireDefault(_techStackTemplate);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var techstack = {
	  template: _techStackTemplate2.default.template,
	  data: function data() {
	    return {
	      vue: '#',
	      mongo: '#',
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/nim/MKS/online-speed-dating/App/Client/Templates/techStackTemplate.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	module.exports = "\n   <section id=\"techStack\" class=\"content-section text-center\">\n        <div class=\"container\">\n            <h2>Tech. Stack</h2>\n            <div class=\"row tech\">\n                <div id=\"vue\" class=\"techicons col-md-3\"> <img class=\"icons\" :src='vue' style=\"width:100px\" alt=\"\"> Vue.js </div>\n                <div id=\"mongo\" class=\"techicons col-md-3\"> <img class=\"icons\" :src='mongo' alt=\"\"> MongoDb </div>\n                <div id=\"express\" class=\"techicons col-md-3\"> <img class=\"icons\" :src='express' alt=\"\"> Express.js </div>\n                <div class=\"techicons col-md-3\"> <img class=\"icons\" :src='pubnub' alt=\"\"> PubNub </div>\n            </div>\n        </div>\n    </section>\n";
